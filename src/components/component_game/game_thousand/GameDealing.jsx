...
import {gameCards, gameCardsDealing, searchGames} from "../../../redux/actions";

const GameDealing = ({setStepOfGame}) => {
    ...
    const [lftAnswerIs, setLftAnswerIs] = useState('')
    const [isStepRht, setIsStepRht] = useState(false)
    const [rhtAnswerIs, setRhtAnswerIs] = useState('')
    const [isStepMe, setIsStepMe] = useState(false)
    ...
    const cardsDealing = useSelector(state => {
        const {cardsListDealingReducer} = state
        return cardsListDealingReducer.cards
    })
    ...
    useEffect(() => {
        ...
        if(lftAnswerIs && rhtAnswerIs){

            setIsStepRht(false)

            dispatch(gameCards(cardsDealing))
            dispatch(gameCardsDealing([]))
    ...
    }, [lftAnswerIs, rhtAnswerIs])

    const showThreeCards = () => {
                ...
                <div className="one-thousand__container game__container container">
                    ...
                    <div className="one-thousand__main">
                        ...
                        <div className="one-thousand__main--grid one-thousand__grid">
                            ...
                            <div className="one-thousand__grid--item">
                                <div className="one-thousand__back-cards">
                                    <ul className="one-thousand__back-cards--list">

                                        {
                                            cardsDealing.map(card =>
                                                <li key={card.id} className={"one-thousand__back-cards--item" + (isShowCards ? " _active" : "")}>
                                ...
                                <div className="game__player">
                                    <div className="game__player--body">
                                        ...
                                        <div className="game__player--info">
                                            ...
                                            {isStepLft ? <progress className="game__user--progress" max="100"
                                ...
                                <div className="game__player">
                                    <div className="game__player--body">
                                        ...
                                        <div className="game__player--info">
                                            ...
                                            {isStepRht ? <progress className="game__user--progress" max="100"
                                                                   value={time * 10}></progress> : ""}
                                        </div>
                                        <div className="game__player--block">
                                            {
                                ...
                                <div className="one-thousand__user game__user">
                                    ...
                                    <div className="game__user--info">
                                        <div className="game__user--info-body">
                                            ...
                                            {isStepMe ? <progress className="game__user--progress" max="100"
                                                                  value={time * 10}></progress> : ""}
                                        </div>
                                    </div>
                                    ...
                                    isStepMe ?
                                        <>
                                            ...
                                            <div className="game__user-menu--row">
                                                {/*<button onClick={e => setStepOfGame(3)} className="game__user-menu--main-btn btn _large _shadow" type="button">*/}
                                                {/*    105*/}
                                                {/*</button>*/}


                                                <button onClick={passOrGame}
