...
const GamesSearchTop = () => {
    ...
    const [inputSearch, setInputSearch] = useState(oldInput)
    ...
    return (
        <div className="online-games__header page-header" data-aos="fade-in" data-aos-delay="200">
            <NavLink to={'/games'} className="online-games__forward-btn page-header__forward-btn" title="Назад">
            ...
            <form onSubmit={handleSearch} action="" className="online-games__search page-header__search">
