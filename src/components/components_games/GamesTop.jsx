...
const GamesTop = (props) => {
    ...
    return (
        <div className="online-games__header page-header" data-aos="fade-in" data-aos-delay="200">
            <Link to={"/"} className="online-games__forward-btn page-header__forward-btn" title="Назад">
            ...
            <h2 className="online-games__section-title section-title page-header__title _decor-none">
                Онлайн игры
            </h2>
            <div className="online-games__bread-crumbs page-header__bread-crumbs">
                <ul className="page-header__bread-crumbs--list">
                    <li className="page-header__bread-crumbs--item">
                        <Link to={"/"} className="page-header__bread-crumbs--link">
                            Главная
                        </Link>
                    </li>
                    <li className="page-header__bread-crumbs--item">
            ...
            <form action="" className="online-games__search page-header__search">
                <label className="page-header__search--label">
                    <input
                        ...
                        onChange={e => props.searchState.setSearchValue(e.target.value)}
                    />
                </label>
                <button className="page-header__search--submit" title="Поиск">
