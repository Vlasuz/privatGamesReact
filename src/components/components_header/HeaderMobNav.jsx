...
import i18next from "../../hooks/I18Next";

const HeaderMobNav = () => {

    const [isAccountMobMenuOpen, setIsAccountMobMenuOpen] = useState(true)
    ...
    return (
        <div className="header__nav-mob--body">
            <ul className="header__nav-mob--list">
                    ...
                    <div
                        ...
                        >
                            ...
                            <span className="header__mob-account--name">
                                {informationOfUser.name ? informationOfUser.name : "Unknown"}
                            </span>
                        ...
                        <div className="header__mob-select--block custom-select__block">
                            <ul className="header__mob-select--list">
                                <li className="header__mob-select--item">
                                    <NavLink to={"/account-main"} className="header__mob-select--link">
                                ...
                                <li className="header__mob-select--item">
                                    <NavLink to={'/account-settings'} className="header__mob-select--link">
                                ...
                                <li className="header__mob-select--item">
                                    <NavLink to={'/account-history'} className="header__mob-select--link">
                                ...
                                <li className="header__mob-select--item">
                                    <NavLink to={'/account-referal'} className="header__mob-select--link">
                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <li className="header__mob-select--item">
                                    <NavLink to={'/account-withdrawals'} className="header__mob-select--link">
                                ...
                                <li className="header__mob-select--item">
                                    <a href="#promocode-popup" onClick={openPopup}
                                       className="header__mob-select--link _accent open-popup">
                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <li className="header__mob-select--item">
                                    <a href="#" className="header__mob-select--link">
                ...
                <li className="header__nav-mob--item">
                    <NavLink to={'/games'} className="header__nav-mob--link">
                        Игры
                    </NavLink>
                </li>
                <li className="header__nav-mob--item">
                    <NavLink to={'/rooms'} className="header__nav-mob--link">
                        Комнаты
                    </NavLink>
                </li>
                <li className="header__nav-mob--item">
                    <NavLink to={'/news'} className="header__nav-mob--link">
                        Новости
                    </NavLink>
                </li>
                <li className="header__nav-mob--item">
                    <a href="#" className="header__nav-mob--link">
                        Преимущества
                    </a>
                </li>
            </ul>
