...
const NewsTop = ({selectedPage, setSearchInput, searchInput}) => {
    return (
        <div className="news__header page-header" data-aos="fade-in" data-aos-delay="200">
            ...
            <h2 className="news__section-title section-title page-header__title _decor-none">
                {searchInput || selectedPage >= 1 ? "Новости" : "Популярное"}
            </h2>
            ...
            <form onSubmit={e => e.preventDefault()} action="" className="online-games__search page-header__search"><label
                className="page-header__search--label">
                <input onChange={e => setSearchInput(e.target.value)} value={searchInput} type="text" name="search" placeholder="Поиск" required
