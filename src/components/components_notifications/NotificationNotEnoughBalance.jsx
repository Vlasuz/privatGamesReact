...
const NotificationNotEnoughBalance = ({handleClose}) => {
    return (
        <li id={"notification_no-enough-balance"} className="notifications__item notification-item">
...
export default NotificationNotEnoughBalance;